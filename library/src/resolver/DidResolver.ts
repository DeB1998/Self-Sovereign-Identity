...
import {IssuerDidValidityChecker} from "../credential/IssuerDidValidityChecker";
...
import {RevocationList2023Manager} from "../credential/status/RevocationList2023Manager";
import {RevocationList2023CredentialStatus} from "../credential/status/RevocationList2023CredentialStatus";
import {TrustedIssuers} from "../credential/TrustedIssuers";
import {VerifiableCredential} from "../credential/VerifiableCredential";
...
export class DidResolver {
    ...
    public static readonly CERTIFICATION_CREDENTIAL_CONTEXT =
        "https://www.ssicot.com/certification-credential";
    public static readonly CHAIN_OF_TRUST_MAX_LENGTH = 10;
    ...
    constructor(web3: Web3, contractAbi: AbiItem[], contractAddress: string, gasLimit?: number) {
        ...
        this.trustCredentialManager = new VerifiableCredentialManager(
            this,
            new IssuerDidValidityChecker(this),
            new EcdsaSecp256k1ProofManager(this.web3, this),
            new RevocationList2023Manager(this)
        );
        this.chainId = 0;
    }
    ...
    public async updateTrustCertification(
        ...
        trustedCredentialIssuers: TrustedIssuers,
    ...
    private async executeCredentialStatusResolution(
        ...
        const status: JsonLdObject<RevocationStatus> = {
        ...
        return {
            ...
            contentMetadata: {resourceType: ResourceType.REVOCATION_LIST_2023_STATUS}
        };
    }
    ...
    private async createService(
        ...
        let serviceWithContext: JsonLdObject<Service> | undefined = undefined;
    ...
    ): Promise<JsonLdObject<VerificationMethod>> {
        const verificationMethod = (await this.composeVerificationMethod(
            did,
            response
        )) as JsonLdObject<VerificationMethod>;
